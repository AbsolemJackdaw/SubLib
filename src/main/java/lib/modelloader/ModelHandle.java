...
public class ModelHandle {
    ...
    /**
     * @param texChannel
     *            : the texture channel, a.k.a the texture identifier name (example
     *            for blocks : "all", or "side")
     * @param resloc
    ...
    public static void init() {
        ...
        MODEL_BAKERY = new ModelLoader(Minecraft.getInstance().getResourceManager(),
                Minecraft.getInstance().getTextureMap(), Minecraft.getInstance().getBlockColors(),
    ...
    private static IBakedModel loadModel(ModelHandle handle) {
        ...
        try {
            ...
            model = mod.bake(MODEL_BAKERY, ModelLoader.defaultTextureGetter(), new BasicState(state, handle.uvLocked()),
                    handle.getVertexFormat());
