...
public class PlayerClassCapability {
	...
	public static class StorageHelper implements Capability.IStorage<PlayerClass>{
		...
		@Override
		public NBTBase writeNBT(Capability<PlayerClass> capability, PlayerClass instance, EnumFacing side)		{
			return instance.writeData();
		}

		@Override
		public void readNBT(Capability<PlayerClass> capability, PlayerClass instance, EnumFacing side, NBTBase nbt){
